...
export declare type RegistryMsgUnsubscribeValidatorResponse = object;
/**
 * Params defines the parameters for the module.
 */
export declare type RegistryParams = object;
export interface RegistryQueryAllConsumerResponse {
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
    queryConsumerAll: (query?: {
        "pagination.key"?: string;
        "pagination.offset"?: string;
        "pagination.limit"?: string;
        "pagination.countTotal"?: boolean;
        "pagination.reverse"?: boolean;
    }, params?: RequestParams) => Promise<HttpResponse<RegistryQueryAllConsumerResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryConsumer: (index: string, params?: RequestParams) => Promise<HttpResponse<RegistryQueryGetConsumerResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
