...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryConsumerAll = (
    ...
    this.request<RegistryQueryAllConsumerResponse, RpcStatus>({
   ...
   */
  queryConsumer = (index: string, params: RequestParams = {}) =>
    this.request<RegistryQueryGetConsumerResponse, RpcStatus>({
  ...
  queryParams = (params: RequestParams = {}) =>
    this.request<RegistryQueryParamsResponse, RpcStatus>({
      path: `/sainoe/registry/registry/params`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  querySubscriptionAll = (
    ...
    this.request<RegistryQueryAllSubscriptionResponse, RpcStatus>({
